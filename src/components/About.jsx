  ...
  return (
    <section className='About content container'>
      ...
      <p>This is a zero-player "game" invented by late mathematician John H. Conway. 
        ...
        For more information, visit the <a rel='noopener noreferrer' target='_blank' href='https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life'>Wikipedia</a> page.</p>
      <p>Site created by <a rel='noopener noreferrer' target='_blank' href='https://github.com/drew-ross'>Drew Ross</a>.</p>
    </section>
  );
};
